...
public class Admin extends User {
    ...
    // AdminDashboardDisplayStrategy adminStrategy = new
    // AdminDashboardDisplayStrategy();
    ...
    // course.getCourseId().equalsIgnoreCase(id)) {
    ...
    // System.out.println("Enter new scope for further studies (separated by
    // commas): ");
    // course.setScopeForFutherStudies(input.nextLine().split(","));

    // System.out.println("Does the course offer scholarship facilities?
    // (true/false) ");
    ...
    // System.out.println(
    // "Enter new medium of study (FOUNDATION, DIPLOMA, UNDERGRADUATE, POSTGRADUATE,
    // PHD): ");
    // course.setMediumStudy(MediumOfStudy.valueOf(input.next().toUpperCase()));

    // System.out.println("\nCourse " + course.getCourseName() + " has been updated
    // successfully.");
